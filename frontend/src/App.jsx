...
import Dept_M from './components/dept_m';
import View_Ticket from './components/view_ticket';
import Desig_M from './components/desig_m';
import Plant_M from './components/plant_m';
import Product_M from './components/product_m';
import Service_M from './components/service_cat_m';
import Root_M from './components/root_cause_m';

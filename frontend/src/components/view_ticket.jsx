...
const View_Ticket = () => {
    ...
    if (searchInput) {
      filteredResults = filteredResults.filter((item) => {
        ...
        return (
          ...
          (item.Service_category && item.Service_category.toLowerCase().includes(searchInput.toLowerCase()))
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:3001/view_ticket`)
      .then((response1) => {
              ...
              <div className="card-body">
                <div className="table-responsive">
                  <table
                    ...
                    cellSpacing={0}
                  >
                    <thead style={{ backgroundColor: "#3c53e1", color: "white" }}>
                      <tr>
                        <th>Sl.No</th>
                        <th>Ticket Id</th>
                        <th>Raised Date</th>
                    ...
                    <tbody>
                      {data.map((item, index) => (
                        <tr key={index}>
                          <td> {index + 1}</td>
                          <td className='ticketIdStyle'onClick={() => handleOpen(item)}>{item.Ticket_id}</td>
                              ...
                              <Fade in={open}>
                                <Box className='view_ticket_modal1'>
                                  ...
                                  <div className="details">
                                    <div className="section" style={{marginLeft:"5%", padding:10}}>
                                      <div className="row1">
                                        <label htmlFor="assetId">Ticket ID:</label>
                                        <input type="text" id="assetId" value={item.Ticket_id} readOnly />
                                      </div>
                                      <div className="row1">
                                        <label htmlFor="assetId">Plant Code:</label>
                                        <input type="text" id="assetId" value={plantcode} readOnly />
                                      </div>
                                    </div>
                                    <div className="section" style={{marginRight:"10%", padding:10}}>
                                      
                                      <div className="row1">
                                        <label htmlFor="department">User ID:</label>
                                        <input type="text" id="department" value={userid} readOnly />
                                      </div>
                                      <div className="row1">
                                        <label htmlFor="problemDescription">User Name:</label>
                                        <input type="text" id="department" value={username} readOnly />
                                      </div>
                                    </div>

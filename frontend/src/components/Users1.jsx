...
import { Modal, Button, Typography, Box, Backdrop, TextField,Select,MenuItem ,FormControl ,InputLabel } from '@mui/material';
...
const Users1 = () => {
    ...
    if (searchInput) {
      filteredResults = filteredResults.filter((item) => {
        ...
        return (
          ...
          (item.Plant_name && item.Plant_name.toLowerCase().includes(searchInput.toLowerCase())) ||
  ...
  const fetchUsers = () => {
    const plantcode = localStorage.getItem('plantcode');
    axios.get(`http://localhost:3001/users?plantcode=${plantcode}`)
      .then((response) => {
                  ...
                  >
                    ...
                    <tbody>
                      {filteredData.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td className='UserStyle' onClick={() => handleOpen(item)}>{item.Userid}</td>
                          <td>{item.Username}</td>
                                      ...
                                      <div style={{ display: 'flex', justifyContent: 'space-evenly', flexDirection: 'column' }}>
                                        <div>
                                          <TextField
                                            ...
                                            value={editedUser}
                                            variant="outlined"
                                            style={{ margin: '2rem', pointerEvents: 'none', cursor: 'initial' }}
                                          ...
                                          />
                                          <FormControl variant="outlined" style={{ margin: '2rem', width: '37%' }}>
                                            ...
                                            >
                                              {departmentCodes.map((code, index) => (
                                                <MenuItem key={index} value={code.Dept_name}>
                                                  {code.Dept_code} - {code.Dept_name}
                                                </MenuItem>
                                              ))}
                                            </Select>
                                          </FormControl>
                                          <FormControl variant="outlined" style={{ margin: '2rem', width: '37%' }}>
                                            <InputLabel id="plantname-label">Plant Name</InputLabel>
                                            <Select
                                            ...
                                            >
                                              {plantCodes.map((name, index) => (
                                                <MenuItem key={index} value={name.Plant_name}>
                                                  {name.Plant_code} - {name.Plant_name}
                                                </MenuItem>
                                              ))}
                                            </Select>
                                          </FormControl>
                                          <FormControl variant="outlined" style={{ margin: '2rem', width: '37%' }}>
                                            ...
                                            <Select
                                                ...
                                                >
                                                  {designationCodes.map((desig,index) => (
                                                    <MenuItem key={index} defaultValue={designation} value={desig.Designation}>
                                                      {desig.Designation_id} - {desig.Designation}
                                                    </MenuItem>
                                                  ))}
                                                </Select>
                                          </FormControl>
                                        ...
                                        <div>
                                          ...
                                          <TextField
                                            ...
                                            style={{ margin: '2rem', cursor: 'initial' }}
                            ...
                            {selectedUser && (
                              <Fade in={open}>
                                <Box className='contact-modal1'>
                                  ...
                                  <div><hr style={{ border: '2 solid white' }} /></div>
                                  <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                                    <div>
                                      <Typography variant="h6" style={{ textAlign: 'left' }}>User Name</Typography>
                                      <Typography variant="h6">Phone Number</Typography>
                                      <Typography variant="h6">Mail Id</Typography>
                                    ...
                                    <div>
                                      ...
                                      <Typography variant="h6">: {department}</Typography>
                                      <Typography variant="h6">: {designation}</Typography>
                                      <Typography variant="h6">: {plantname}</Typography>
                                  ...
                                  <Button
                                    ...
                                    color="error"
                                    onClick={handleClose}
                                    style={{ backgroundColor: red[500], width: 3, marginLeft: '45%' }}
                                  >Close</Button>
